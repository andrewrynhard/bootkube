...
vendor:
	@dep ensure -v
	@curl https://raw.githubusercontent.com/kubernetes/kubernetes/v1.16.0/pkg/kubelet/util/util.go | sed 's/^package util$$/package internal/' > pkg/checkpoint/internal/util.go
	@curl https://raw.githubusercontent.com/kubernetes/kubernetes/v1.16.0/pkg/kubelet/util/util_unix.go | sed 's/^package util$$/package internal/' > pkg/checkpoint/internal/util_unix.go
