module github.com/andrewrynhard/bootkube
...
require (
	...
	github.com/kubernetes-incubator/bootkube v0.14.0
	...
	golang.org/x/text v0.3.1-0.20180302201248-b7ef84aaf62a // indirect
